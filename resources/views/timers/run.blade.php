<x-layouts.app>
    ...
    <div class="p-8 max-w-4xl mx-auto">
        ...
        <!-- Meeting Countdown -->
        <div class="mb-8 p-6 bg-timerbot-panel-light rounded-sm text-center">
            ...
            <div id="meeting-countdown" class="text-5xl font-bold text-timerbot-orange tabular-nums" style="font-family: var(--font-display);">
                --:--:--
            </div>
        ...
        <div id="speaker-panel" class="hidden mb-8 p-8 bg-timerbot-panel-light rounded-sm text-center border-2 border-timerbot-green">
            ...
            <div id="speaker-countdown" class="text-8xl font-bold text-timerbot-green tabular-nums my-4" style="font-family: var(--font-display);">
                --:--
            </div>
        ...
        <div class="mb-8 flex justify-center gap-4">
            <button id="btn-start" onclick="timerApp.start()" class="btn btn-primary text-lg px-8 py-3">
                Start
            </button>
            <button id="btn-next" onclick="timerApp.nextSpeaker()" class="hidden btn bg-timerbot-orange text-timerbot-black hover:bg-timerbot-peach text-lg px-8 py-3">
                Next Speaker
            </button>
            <button id="btn-pause" onclick="timerApp.togglePause()" class="hidden btn bg-timerbot-panel text-timerbot-cyan hover:bg-timerbot-cyan hover:text-timerbot-black text-lg px-8 py-3">
                Pause
            </button>
        </div>
        ...
        <!-- Completed Message -->
        <div id="completed-section" class="hidden mb-8 p-8 bg-timerbot-panel-light rounded-sm text-center border-2 border-timerbot-green">

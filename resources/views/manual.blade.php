<x-layouts.app>
    <div class="max-w-4xl mx-auto px-4 py-8">
        ...
        <div class="space-y-12">
            ...
            <section id="running-a-timer" class="border-t border-subtle mt-4 pt-2">
                ...
                <div class="space-y-4 text-sm leading-relaxed">
                    ...
                    <h3 class="text-timerbot-teal uppercase tracking-wide" style="font-family: var(--font-display);">Speaker Panel</h3>
                    <p>
                    ...
                    <h3 class="text-timerbot-teal uppercase tracking-wide" style="font-family: var(--font-display);">Speaker History</h3>
                    <p>
            ...
            <section id="activity-log" class="border-t border-subtle mt-4 pt-2">
                ...
                <div class="space-y-4 text-sm leading-relaxed">
                    ...
                    <h3 class="text-timerbot-teal uppercase tracking-wide" style="font-family: var(--font-display);">Filtering</h3>
                    <p>
                        Filter the log by:
                    </p>
                    <ul class="list-disc list-inside ml-4 space-y-1">
        ...
        <div class="mt-10 pt-4 border-t border-subtle text-center">
            <a href="#" class="text-timerbot-teal hover:text-timerbot-lime text-sm" style="font-family: var(--font-display);">
                &uarr; Back to Top
            </a>
        </div>

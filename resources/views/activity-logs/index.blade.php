                            ...
                            <tr class="hover:bg-timerbot-panel-light transition-colors">
                                ...
                                <td class="p-4 border-b border-dark-green/50">
                                    @if($log->loggableExists())
                                        ...
                                        @else
                                            <span class="text-timerbot-lime">{{ $log->getLoggableDisplayName() }}</span>
                                        @endif
                                ...
                                <td class="p-4 border-b border-dark-green/50">
                                    ...
                                    @elseif($log->action === 'run' && is_array($log->changes))
                                        ...
                                        @endif
                                    @endif
                                    <a href="{{ route('activity-logs.show', $log) }}" class="px-3 py-1.5 rounded-none bg-timerbot-panel-light text-timerbot-lime hover:bg-timerbot-lime hover:text-timerbot-black transition-all text-xs uppercase tracking-wider no-underline ml-2" style="font-family: var(--font-display);">
                                        View
                                    </a>
                                </td>
                            </tr>

...
>
    <div class="flex items-center justify-center min-h-screen px-4">
        ...
        >
            ...
            <div class="p-6">
                <h3 class="text-xl font-semibold mb-2 text-timerbot-teal" style="font-family: var(--font-display);">Generate Image?</h3>
                ...
                <div class="flex justify-end gap-3">
                    <button
                        type="button"
                        x-on:click.prevent.stop="open = false"
                        class="px-5 py-2 rounded-none bg-timerbot-panel-light text-text hover:bg-timerbot-teal hover:text-timerbot-black transition-all duration-200 uppercase text-sm tracking-wider"
                    ...
                    <button
                        ...
                        class="px-5 py-2 rounded-none bg-timerbot-teal text-timerbot-black hover:shadow-lg hover:shadow-timerbot-teal/30 transition-all duration-200 uppercase text-sm tracking-wider"
                        style="font-family: var(--font-display);"
                    >
                        Generate Image
                    </button>

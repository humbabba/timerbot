...
var noSleep = new (nosleep_js__WEBPACK_IMPORTED_MODULE_0___default())();
...
var updateTimerView = function updateTimerView(info) {
  var valuesToUpdate = ['guys', 'current_guy', 'now', 'end_time', 'remaining', 'time_per_guy', 'current_guy_remaining', 'current_guy_alarm_status', 'current_guy_over', 'started', 'over', 'message'];
